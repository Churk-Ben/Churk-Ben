...
export const NAV_DATA: NavData[] = [
    {
        ...
        items: [
            ...
            {
                icon: 'https://squoosh.app/logo.ico',
                title: 'Squoosh',
            ...
            {
                icon: '/icons/shieldsio.svg',
                title: 'Shields.io',
                desc: '制作简洁、一致、易读的徽章',
                link: 'https://shields.io'
            },
            {
                icon: '/icons/lanrenexcel.svg',
                title: '懒人 Excel',
    ...
    },
    {
        ...
        items: [
            ...
            {
                icon: 'https://houdini.how/favicon.ico',
                title: 'Houdini.how',
    ...
    },
    {
        ...
        items: [
            ...
            {
                icon: 'https://rspack.dev/favicon.ico',
                title: 'Rspack',
    ...
    },
    {
        ...
        items: [
            ...
            {
                icon: 'https://icons.pqoqubbw.dev/favicon.svg',
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                icon: 'https://www.typescriptlang.org/icons/icon-72x72.png?v=8944a05a8b601855de116c8a56d3b3ae',
                title: 'TypeScript 教程',
                desc: '阮一峰 TypeScript 开源教程，介绍基本概念和用法，面向初学者',
